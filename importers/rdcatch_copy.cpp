  ...
  : QObject(parent)
{
  ...
  while(q->next()) {
    sql=QString("insert into RECORDINGS set ")+
      ...
      "SUN=\""+q->value(4).toString()+"\","+
      "MON=\""+q->value(5).toString()+"\","+
      "TUE=\""+q->value(6).toString()+"\","+
      "WED=\""+q->value(7).toString()+"\","+
      "THU=\""+q->value(8).toString()+"\","+
      "FRI=\""+q->value(9).toString()+"\","+
      "SAT=\""+q->value(10).toString()+"\","+
      "DESCRIPTION=\""+RDEscapeString(q->value(11).toString())+"\","+
      QString().sprintf("START_TYPE=%d,",q->value(12).toInt())+
      "START_TIME=\""+q->value(13).toString()+"\","+
