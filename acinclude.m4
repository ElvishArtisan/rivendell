...
[
  ...
  if test x"$with_Qt_dir" = x"no" ||
    ...
    if test x"$with_Qt_dir" != x; then
      ...
      bnv_qt_LIBS="-L$bnv_qt_lib_dir -l$bnv_qt_lib $X_PRE_LIBS $X_LIBS -lX11 -lXext -lXi $X_EXTRA_LIBS"
    else
...
[
  ...
  if (test -x $bnv_possible_qt_dir/bin/moc) &&
    ...
    if test x"$with_Qt_lib_dir" != x; then
      ...
      bnv_save_LIBS="$LIBS"
      LIBS="-l$bnv_qt_lib $X_PRE_LIBS $X_LIBS -lX11 -lXext -lXi $X_EXTRA_LIBS"
      bnv_qt_LIBS="$LIBS"
