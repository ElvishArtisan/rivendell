...
double RDLogLine::timescaleLimit() const
{
  return log_timescale_limit;
}


void RDLogLine::setTimescaleLimit(double limit)
{
  log_timescale_limit=limit;
}
