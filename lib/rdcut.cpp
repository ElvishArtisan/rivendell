...
QString RDCut::xml(RDSqlQuery *q,bool absolute,RDSettings *settings)
{
  ...
  if(absolute) {
    ...
    xml+="  "+
      RDXmlField("endPoint",q->value(64).toInt()-q->value(63).toInt());
    if(q->value(65).toInt()<0) {
      xml+="  "+RDXmlField("fadeupPoint",-1);
    }
    else {
      xml+="  "+
	RDXmlField("fadeupPoint",q->value(65).toInt()-q->value(63).toInt());
    }
    if(q->value(66).toInt()<0) {
      ...
      xml+="  "+
	RDXmlField("fadedownPoint",q->value(66).toInt()-q->value(63).toInt());
    }
    if(q->value(67).toInt()<0) {
      ...
      xml+="  "+RDXmlField("segueStartPoint",
			   q->value(67).toInt()-q->value(63).toInt());
      xml+="  "+RDXmlField("segueEndPoint",
			   q->value(68).toInt()-q->value(63).toInt());
    }
    xml+="  "+RDXmlField("segueGain",q->value(69).toInt());
