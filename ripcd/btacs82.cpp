...
//
//      $Id: btacs82.cpp,v 1.14 2010/08/03 23:39:25 cvs Exp $
//
...
RDMatrix::Type BtAcs82::type()
{
  return RDMatrix::BtAcs82;
}


unsigned BtAcs82::gpiQuantity()
{
  return bt_gpis;
}


unsigned BtAcs82::gpoQuantity()
{
  return bt_gpos;
}


bool BtAcs82::primaryTtyActive()
{
  return true;
}


bool BtAcs82::secondaryTtyActive()
{
  return false;
}
