  ...
  : Switcher(matrix,parent,name)
{
  ...
  //
  bt_istate=0;
  for(int i=0;i<BTSS44_GPIO_PINS;i++) {
...
RDMatrix::Type BtSs44::type()
{
  return RDMatrix::BtSs44;
}


unsigned BtSs44::gpiQuantity()
{
  return bt_gpis;
}


unsigned BtSs44::gpoQuantity()
{
  return bt_gpos;
}


bool BtSs44::primaryTtyActive()
{
  return true;
}


bool BtSs44::secondaryTtyActive()
{
  return false;
}
...
void BtSs44::gpiOneshotData(void *data)
{
...
void BtSs44::gpoOneshotData(void *data)
{
